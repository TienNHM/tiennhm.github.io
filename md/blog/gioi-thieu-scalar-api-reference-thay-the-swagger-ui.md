...
> Nguồn: https://tiennhm.io.vn/blog/gioi-thieu-scalar-api-reference-thay-the-swagger-ui
> Scalar là open-source API Reference UI hiện đại thay thế Swagger UI. Tìm hiểu lý do Microsoft loại bỏ Swashbuckle khỏi .NET 9/10, so sánh Scalar vs Swagger UI, và hướng dẫn setup Scalar trên ASP.NET Core 10 từng bước.
...
## Bảo mật endpoint `/openapi` và `/scalar` trong Production
