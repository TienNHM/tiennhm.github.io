...
Cái được ở đây là luật "ai được động vào Order" nằm gọn trong một handler, sửa một lần là mọi nơi gọi nó đổi theo, thay vì phải đi tìm từng câu `if` rải rác. Cách khai báo requirement và handler được trình bày chi tiết ở [bài resource-based authorization](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-03-aspnet-core-backend/module-10-authentication-authorization/10.6-resource-based-authorization), còn phần khai báo policy để gắn vào endpoint thì ở [bài policy-based authorization](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-03-aspnet-core-backend/module-10-authentication-authorization/10.5-policy-based-authorization).
