...
> Nguồn: https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-03-git-developer-workflow/3.6-branching-and-merging
...
**Tiêu chí hoàn thành:** hai commit cuối cùng đều thoả tiêu chí ở [bài 3.5](3.5-workflow-co-ban.mdx) — `revert` riêng từng cái mà hệ thống vẫn chạy.
...
Dùng `--force-with-lease` chứ không phải `--force`, vì lý do đã chứng minh bằng thực nghiệm ở [bài 3.4](3.4-git-safety-checklist.mdx).
