...
> Nguồn: https://tiennhm.io.vn/docs/k6/load-testing-restful-apis-with-k6-part-03
...
> **Warning: Lưu ý quan trọng, chúng ta chỉ định từ khóa `export` cho `options` và `default` để k6 có thể nhận diện được các giá trị này.**
>
>
