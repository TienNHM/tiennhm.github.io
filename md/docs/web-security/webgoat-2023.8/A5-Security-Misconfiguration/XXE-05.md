...
> Nguồn: https://tiennhm.io.vn/docs/web-security/webgoat-2023.8/A5-Security-Misconfiguration/XXE-05
...
- **`&root;`**: Chèn nội dung thư mục vào phản hồi.
...
```
👉 **Lý do:**
- JavaScript trên trang web tự động **bọc nội dung input vào cặp `...`**.
