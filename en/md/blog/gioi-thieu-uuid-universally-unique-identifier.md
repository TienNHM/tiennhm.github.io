...
- [1.2 — 1. Biến và Kiểu Dữ Liệu](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-01-programming-logic/1.1-variables-and-data-types) — Biến, kiểu giá trị và kiểu tham chiếu, vì sao tiền phải dùng decimal chứ không phải double, DateTime hay DateTimeOffset, và nullable reference types…
