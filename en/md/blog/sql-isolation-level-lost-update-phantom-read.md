...
- [16. Transactions - ACID](https://tiennhm.io.vn/docs/database/learn-sql-in-30-days/16-transactions-acid) — Giới thiệu về Transactions trong SQL, cách sử dụng và đảm bảo tính nhất quán dữ liệu với ACID.
