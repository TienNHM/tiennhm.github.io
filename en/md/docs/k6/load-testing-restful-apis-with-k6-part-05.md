...
> Nguồn: https://tiennhm.io.vn/en/docs/k6/load-testing-restful-apis-with-k6-part-05
...
> **Tip: Toàn bộ **source code** của bài viết này có thể tìm thấy tại [đây](https://github.com/TienNHM/k6-load-testing-results-visualization-with-grafana). Bạn có thể clone về và thực hành theo hướng dẫn trong bài viết.**
>
