# M02.08 - Messaging and Queuing

> Nguồn: https://tiennhm.io.vn/en/docs/aws-cloud-practitioner-essentials/compute-in-the-cloud/messaging-and-queuing
> Tìm hiểu về messaging và queuing trong AWS, bao gồm Amazon SQS, Amazon SNS và Amazon EventBridge. Khám phá sự khác biệt giữa tightly coupled và loosely coupled architectures, và cách message queues giúp cải thiện communication giữa các components.
