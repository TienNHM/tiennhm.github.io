...
> Nguồn: https://tiennhm.io.vn/en/docs/aws-cloud-practitioner-essentials/exploring-compute-services/introduction-to-serverless-computing
> Tìm hiểu về serverless computing và sự khác biệt giữa unmanaged, managed, và serverless compute services trong AWS. Khám phá trách nhiệm của khách hàng và AWS đối với serverless computing.
