# Phần 7 - UX Best Practices

> Nguồn: https://tiennhm.io.vn/en/docs/agent-skills/agent-skills-05-ux-best-practices
> Tổng hợp UX guidelines chung cho Agent Skills – Navigation, Animation, Layout, Touch, Interaction, Accessibility, Performance, Forms, Responsive, Typography, Feedback, Content, Onboarding, Search, Data Entry, AI Interaction, Spatial UI, Sustainability.
...
- **Không nên:** Script sync trong `` chặn render.
