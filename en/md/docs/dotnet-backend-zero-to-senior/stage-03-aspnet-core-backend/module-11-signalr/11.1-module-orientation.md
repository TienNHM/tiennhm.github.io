# 11.1 — Module Orientation

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-03-aspnet-core-backend/module-11-signalr/11.1-module-orientation
> Định hướng Module 11 — Signalr: mục tiêu, thứ tự bài học và liên kết tới chương trước — chương sau trong lộ trình .NET backend.
...
### 11.1.1 — 11.1 — Liên kết điều phối (curriculum graph)

- **Hub lộ trình**: [00. Lộ trình From Zero → Senior .NET (Backend-first)](../../roadmap-dotnet-backend-zero-to-senior.mdx)
- **Chương trước**: [Module 10 — Authentication + Authorization](../module-10-authentication-authorization/)
- **Chương tiếp theo**: [Project 2 — CRM Backend API](../project-02-crm-backend-api.mdx)

### 11.1.2 — 11.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 11.1.3 — 11.3 — Từ khóa chỉ mục (semantic hooks)
...
### 11.1.4 — 11.4 — Phương pháp học tập
...
- **Bài tiếp theo:** [11.2 — 1. Tại sao cần Real-time?](11.2-tai-sao-can-real-time.mdx)
