...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-03-aspnet-core-backend/module-11-signalr/11.3-signalr-architecture
...
Muốn gửi từ ngoài ngữ cảnh một lời gọi thì dùng `IHubContext` ([bài 11.8](11.8-ihubcontext-server-push-outside-hub.mdx)).
