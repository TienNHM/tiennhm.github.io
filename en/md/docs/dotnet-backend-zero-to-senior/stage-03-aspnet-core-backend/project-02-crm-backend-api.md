...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-03-aspnet-core-backend/project-02-crm-backend-api
...
description: "Project CRM Backend API: aggregate roots, use cases, authZ, SignalR hooks — API production-shaped cho miền khách hàng và cơ hội bán hàng."
sidebar_position: 5
tags:
  - crm-backend
  - capstone
...
- **Chương trước**: [Module 11 — SignalR](module-11-signalr/)
- **Chương tiếp theo**: [Module 12 — SQL Deep Dive](../stage-04-database-production/module-12-sql-deep-dive/)
...
5. `NotificationService` gọi `IHubContext` để push real-time:
   ```csharp
...
Dùng `WebApplicationFactory` + in-memory database:
...
|-----|---------------------------|
| **Trước** | [Module 11 — SignalR](module-11-signalr/) |
| **Tiếp theo** | [Module 12 — SQL Deep Dive](../stage-04-database-production/module-12-sql-deep-dive/) |
