# 10.13 — Ví dụ thực tế nhanh

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-03-aspnet-core-backend/module-10-authentication-authorization/10.13-quick-real-world-example
> Nhân viên sửa được lead của người khác bằng cách đổi id trên URL: vì sao role check không đủ và cách phân quyền theo tài nguyên.
...
### Vì sao Authorize theo vai trò không đủ?
...
### Vì sao lỗ hổng này ít bị phát hiện trong test?
...
### Vì sao tách thành policy tốt hơn kiểm tra trong controller?
...
### Vì sao không dùng được attribute Authorize với policy tài nguyên?
...
### Sự khác biệt giữa 403 và 404 làm lộ gì?
...
### Cái bẫy tinh vi của global query filter là gì?

EF Core cache model đã dựng, nên nếu biểu thức filter chụp giá trị TenantId tại thời điểm dựng model thì mọi tenant sau đó dùng chung giá trị của tenant đầu tiên. Phải tham chiếu tới service trong biểu thức chứ không tới giá trị.
