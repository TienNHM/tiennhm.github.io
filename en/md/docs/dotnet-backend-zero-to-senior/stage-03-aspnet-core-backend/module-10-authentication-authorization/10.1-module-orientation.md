...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-03-aspnet-core-backend/module-10-authentication-authorization/10.1-module-orientation
> Định hướng Module 10 — Authentication authorization: mục tiêu, thứ tự bài học và liên kết tới chương trước — chương sau trong lộ trình .NET backend.
...
### 10.1.1 — 10.1 — Liên kết điều phối (curriculum graph)
...
### 10.1.2 — 10.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 10.1.3 — 10.3 — Từ khóa chỉ mục (semantic hooks)
...
### 10.1.4 — 10.4 — Phương pháp học tập
