...
> Pagination, Filtering, Sorting: Pagination params và response envelope; IQueryable filtering + sorting; Customer list endpoint hoàn chỉnh.
...
### 9.5.1 — 4.1 Pagination params và response envelope
...
### 9.5.2 — 4.2 IQueryable filtering + sorting
...
### 9.5.3 — 4.3 Customer list endpoint hoàn chỉnh
