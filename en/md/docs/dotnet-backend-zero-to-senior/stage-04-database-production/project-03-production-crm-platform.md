...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-04-database-production/project-03-production-crm-platform
...
description: "Production CRM platform: observability, resilience, data tier, CI/CD — capstone tích hợp database, cache, jobs và deployment."
sidebar_position: 5
tags:
...
- **Chương trước**: [Module 15 — Docker + Deployment](module-15-docker-deployment/)
- **Chương tiếp theo**: [Module 16 — Clean Architecture](../stage-05-senior-engineering/module-16-clean-architecture/)
...
|-----|---------------------------|
| **Trước** | [Module 15 — Docker + Deployment](module-15-docker-deployment/) |
| **Tiếp theo** | [Module 16 — Clean Architecture](../stage-05-senior-engineering/module-16-clean-architecture/) |
