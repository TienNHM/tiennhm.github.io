# 12.8 — 8. Database Migration Strategy

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-04-database-production/module-12-sql-deep-dive/12.8-database-migration-strategy
> Expand-contract cho zero-downtime, vì sao ALTER TABLE có thể khoá cả bảng, backfill theo lô, migration không đảo ngược được, và chạy migration khi nào.
