# 12.9 — Mở rộng và đào sâu

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-04-database-production/module-12-sql-deep-dive/12.9-advanced-notes
> Columnstore, temporal table, partition, window function và JSON trong SQL — chủ đề SQL nâng cao và điều kiện dùng.
