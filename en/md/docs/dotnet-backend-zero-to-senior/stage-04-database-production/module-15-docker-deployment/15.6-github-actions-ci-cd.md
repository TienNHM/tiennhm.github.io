# 15.6 — 6. GitHub Actions CI/CD

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-04-database-production/module-15-docker-deployment/15.6-github-actions-ci-cd
> Quyền tối thiểu cho GITHUB_TOKEN, ghim action theo SHA, cache build, environment với phê duyệt, và deploy không lưu khoá SSH.
...
**Không gắn thẻ `latest`** cho artifact triển khai ([bài 15.2](15.1-docker-fundamentals.mdx)). Dùng `sha-` để biết chính xác đang chạy gì và rollback được.
