# 15.10 — 10. .NET Aspire (.NET 8+)

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-04-database-production/module-15-docker-deployment/15.10-dotnet-aspire-dotnet-8-plus
> AppHost mô tả stack bằng C#, service discovery và connection string tự động, dashboard OpenTelemetry, và Aspire không phải công cụ triển khai.
