...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-04-database-production/module-15-docker-deployment/15.7-github-actions-ci-cd
...
**Không gắn thẻ `latest`** cho artifact triển khai ([bài 15.2](15.2-docker-fundamentals.mdx)). Dùng `sha-` để biết chính xác đang chạy gì và rollback được.
