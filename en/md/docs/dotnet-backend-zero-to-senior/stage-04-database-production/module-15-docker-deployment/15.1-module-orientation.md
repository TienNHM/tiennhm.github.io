...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-04-database-production/module-15-docker-deployment/15.1-module-orientation
> Định hướng Module 15 — Docker deployment: mục tiêu, thứ tự bài học và liên kết tới chương trước — chương sau trong lộ trình .NET backend.
...
### 15.1.1 — 15.1 — Liên kết điều phối (curriculum graph)
...
### 15.1.2 — 15.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 15.1.3 — 15.3 — Từ khóa chỉ mục (semantic hooks)
...
### 15.1.4 — 15.4 — Phương pháp học tập
