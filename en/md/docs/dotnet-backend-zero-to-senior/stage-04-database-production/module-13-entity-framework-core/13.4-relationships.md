...
> Relationships: One-to-Many: Customer → Contacts; One-to-One: Customer → CustomerAddress (Owned Entity).
...
### 13.4.1 — One-to-Many: Customer → Contacts
...
### 13.4.2 — Many-to-Many: Lead → Tags (ví dụ mở rộng)
...
### 13.4.3 — One-to-One: Customer → CustomerAddress (Owned Entity)
