...
Trường `traceId` là mã tương quan để tra log — thứ biến câu "tôi gặp lỗi" thành một truy vấn log chính xác. [Bài 8.9](../../stage-03-aspnet-core-backend/module-08-aspnet-core-fundamentals/8.9-global-exception-handling.mdx) trình bày cách cấu hình để mọi ngoại lệ tự động trả về định dạng này.
