# 2.12 — Ví dụ thực tế nhanh

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-02-computer-science-basics/2.12-quick-real-world-example
> Lỗi CORS chặn mọi lời gọi API từ frontend: đọc thông điệp lỗi đúng cách, hiểu preflight, và ba cấu hình sai thường gặp.
