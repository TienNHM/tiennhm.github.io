...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-02-computer-science-basics/2.5-api-and-json
...
**3. Số tiền** — `double` của JSON gặp đúng vấn đề đã nói ở [bài 1.2](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-01-programming-logic/1.1-variables-and-data-types). An toàn nhất là dùng chuỗi hoặc số nguyên đơn vị nhỏ nhất:
