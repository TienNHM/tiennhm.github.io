...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-02-computer-science-basics/2.1-module-orientation
> Module Orientation: Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval); Từ khóa chỉ mục (semantic hooks); Phương pháp học tập; Mục tiêu học tập; Câu hỏi khởi.
...
### 2.1.1 — 2.1 — Liên kết điều phối (curriculum graph)
...
### 2.1.2 — 2.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 2.1.3 — 2.3 — Từ khóa chỉ mục (semantic hooks)
