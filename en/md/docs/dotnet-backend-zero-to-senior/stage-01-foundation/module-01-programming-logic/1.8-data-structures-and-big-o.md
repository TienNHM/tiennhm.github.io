...
Dạng thứ ba chính là N+1, đã gặp ở [bài 1.4](1.4-loops.mdx) và sẽ gặp lại một cách hệ thống ở [Module 13](../../stage-04-database-production/module-13-entity-framework-core/).
...
[Bài 12.5 — Indexing](../../stage-04-database-production/module-12-sql-deep-dive/12.5-indexing.mdx) trình bày đầy đủ cả ba điểm này kèm cách đọc kế hoạch thực thi để biết index có được dùng hay không.
