...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-01-programming-logic/1.8-data-structures-and-big-o
> Big-O đo tốc độ tăng chứ không đo thời gian. Bảng độ phức tạp của các collection trong .NET, vì sao O(n²) chỉ lộ ra khi dữ liệu lớn, và vì sao index trong database chính là ý tưởng này.
...
| Thao tác | `T[]` | `List` | `Dictionary<K,V>` | `HashSet` | `SortedSet` |
|---|---|---|---|---|---|
...
Hai bài đo cụ thể cái giá đó: [Thêm 4 index làm INSERT chậm 6 lần](https://tiennhm.io.vn/blog/chi-phi-ghi-cua-index) và [Có index rồi mà truy vấn vẫn quét toàn bảng?](https://tiennhm.io.vn/blog/sql-index-khong-duoc-dung-sargable). Phần lý thuyết nền nằm ở bài [Index](https://tiennhm.io.vn/docs/database/learn-sql-in-30-days/15-index) trong series học SQL 30 ngày.
...
3. **Đo cái giá của index.** Trên một bảng thử 200.000 dòng, đo thời gian `INSERT` khi không có index và khi có bốn index. Đối chiếu kết quả của bạn với các con số trong bài [chi phí ghi của index](https://tiennhm.io.vn/blog/chi-phi-ghi-cua-index).
...
### Vì sao lỗi O(n²) thường lọt qua vòng kiểm thử?
...
### Ở đâu trong code thường ẩn một O(n²)?
...
### Tìm nhị phân cần điều kiện gì và khi nào nên dùng?
...
### Index trong database liên quan gì tới Big-O?
...
- [`SortedSet`](https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.sortedset-1) — giữ thứ tự với O(log n)
- [`HashSet`](https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.hashset-1) — tra cứu O(1) trung bình
