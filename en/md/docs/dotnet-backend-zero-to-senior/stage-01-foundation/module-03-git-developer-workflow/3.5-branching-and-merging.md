...
**Tiêu chí hoàn thành:** hai commit cuối cùng đều thoả tiêu chí ở [bài 3.5](3.4-basic-git-workflow.mdx) — `revert` riêng từng cái mà hệ thống vẫn chạy.
...
- **Bài trước:** [3.4 — 3. Workflow cơ bản](3.4-basic-git-workflow.mdx)
