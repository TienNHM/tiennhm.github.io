...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-03-git-developer-workflow/3.1-module-orientation
> Định hướng Module 3 — Git developer workflow: mục tiêu, thứ tự bài học và liên kết tới chương trước — chương sau trong lộ trình .NET backend.
...
### 3.1.1 — 3.1 — Liên kết điều phối (curriculum graph)

- **Hub lộ trình**: [00. Lộ trình From Zero → Senior .NET (Backend-first)](../../roadmap-dotnet-backend-zero-to-senior.mdx)
- **Chương trước**: [Module 2 — Computer Science Basics](../module-02-computer-science-basics/)
- **Chương tiếp theo**: [Module 4 — C# Core](../../stage-02-csharp-professional/module-04-csharp-core/)

### 3.1.2 — 3.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 3.1.3 — 3.3 — Từ khóa chỉ mục (semantic hooks)
...
- **Bài tiếp theo:** [3.2 — 1. Git là gì và tại sao cần](3.2-git-intro-and-motivation.mdx)
