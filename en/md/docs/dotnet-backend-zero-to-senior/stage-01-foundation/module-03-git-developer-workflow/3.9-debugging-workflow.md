# 3.9 — 8. Debugging Workflow

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-03-git-developer-workflow/3.9-debugging-workflow
...
Đây chính là `O(log n)` từ [bài 1.8](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-01-programming-logic/1.7-data-structures-and-big-o), áp dụng vào lịch sử commit.
...
Lưu ý về `dotnet-counters`: nếu thấy bộ nhớ cao mà GC không giảm, đọc lại [bài 2.10](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-02-computer-science-basics/2.9-dotnet-runtime-and-ecosystem) — Server GC giữ bộ nhớ là hành vi cố ý, không phải rò rỉ.
