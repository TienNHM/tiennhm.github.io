# 16.15 — Ví dụ thực tế nhanh

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-05-senior-engineering/module-16-clean-architecture/16.15-quick-real-world-example
> Một quy tắc nghiệp vụ nằm ở bốn nơi với ba phiên bản khác nhau: cách tìm, cách gom về entity, và cách tự kiểm tra trong vài phút.
