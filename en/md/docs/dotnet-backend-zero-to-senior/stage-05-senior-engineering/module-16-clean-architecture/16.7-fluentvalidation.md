# 16.7 — 7. FluentValidation

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-05-senior-engineering/module-16-clean-architecture/16.7-fluentvalidation
> Ranh giới giữa validation đầu vào và bất biến domain, validator không được gọi database, When và Unless, và cách test validator.
