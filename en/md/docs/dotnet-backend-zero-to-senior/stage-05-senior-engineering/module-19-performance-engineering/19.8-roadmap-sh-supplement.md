# 19.8 — Bổ sung (đối chiếu roadmap.sh)

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-05-senior-engineering/module-19-performance-engineering/19.8-roadmap-sh-supplement
> Module 19 phủ được gì trong nhánh performance của roadmap.sh backend, phần nào cố tình bỏ qua, và thứ tự học tiếp.
