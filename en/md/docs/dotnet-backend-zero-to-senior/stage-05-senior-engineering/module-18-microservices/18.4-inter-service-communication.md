# 18.4 — 4. Giao tiếp giữa các service

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-05-senior-engineering/module-18-microservices/18.4-inter-service-communication
> REST, gRPC hay message bus: chọn theo nhu cầu nhất quán chứ không theo hiệu năng, và vì sao chuỗi gọi đồng bộ là nguồn lỗi cascade.
