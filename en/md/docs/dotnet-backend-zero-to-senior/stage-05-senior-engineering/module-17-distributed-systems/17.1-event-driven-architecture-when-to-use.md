# 17.1 — 1. Event-driven architecture (EDA) — khi nào dùng?

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-05-senior-engineering/module-17-distributed-systems/17.1-event-driven-architecture-when-to-use
