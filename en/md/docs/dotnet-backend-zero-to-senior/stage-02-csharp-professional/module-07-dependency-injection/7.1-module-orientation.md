...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-07-dependency-injection/7.1-module-orientation
> Định hướng Module 7 — Dependency injection: mục tiêu, thứ tự bài học và liên kết tới chương trước — chương sau trong lộ trình .NET backend.
...
### 7.1.1 — 7.1 — Liên kết điều phối (curriculum graph)
...
### 7.1.2 — 7.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 7.1.3 — 7.3 — Từ khóa chỉ mục (semantic hooks)
