...
1. **Captive dependency mà validator không bắt.** Viết một factory `AddSingleton(sp => new Foo(sp.GetRequiredService()))`, bật `ValidateScopes`, chạy và xác nhận nó **không** báo lỗi. Ghi lại ý nghĩa của điều đó với code review.
