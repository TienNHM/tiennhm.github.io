...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-07-dependency-injection/7.6-registering-services
...
Nhớ hai điều từ [bài 7.3](7.3-ioc-container-and-di-container.mdx): `GetRequiredService<IValidator>()` chỉ trả về cái **cuối cùng**, còn `IEnumerable<>` trả về **tất cả** theo thứ tự đăng ký.
