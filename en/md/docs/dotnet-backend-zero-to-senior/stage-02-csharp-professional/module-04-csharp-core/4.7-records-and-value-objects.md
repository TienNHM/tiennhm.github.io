# 4.7 — 7. Records và Value Objects (C# 9+)

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-04-csharp-core/4.7-records-and-value-objects
...
Hai thứ đầu là lý do record dùng làm **khoá `Dictionary`** được ngay, không cần override gì — đúng vấn đề đã nêu ở [bài 1.6](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-01-programming-logic/1.5-arrays-and-lists).
