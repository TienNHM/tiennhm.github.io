# 4.8 — 8. Pattern Matching (C# 8+)

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-04-csharp-core/4.8-pattern-matching
...
**1. Một biểu thức `switch` dài hơn 15 nhánh.** Nó đã thành một bảng dữ liệu viết nhầm thành code — xem lại [bài 1.3](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-01-programming-logic/1.2-conditions).
