# 5.11 — Ví dụ thực tế nhanh

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-05-advanced-csharp/5.11-quick-real-world-example
> Event handler giữ sống một service suốt vòng đời ứng dụng: rò rỉ bộ nhớ do quên huỷ đăng ký, và ba cách phòng.
