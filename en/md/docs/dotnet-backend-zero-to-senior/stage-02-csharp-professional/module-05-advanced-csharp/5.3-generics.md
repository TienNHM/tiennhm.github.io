...
**Ứng dụng thực tế.** Đây là lý do nên trả về `IEnumerable` hoặc `IReadOnlyList` thay vì `List` từ API công khai — ngoài lý do đóng gói ở [bài 4.3](../module-04-csharp-core/4.3-encapsulation.mdx), nó còn cho người gọi sự linh hoạt về kiểu:
...
`Counter.Value` là **một** biến duy nhất cho toàn bộ ứng dụng. Hai request đồng thời cùng tăng nó sẽ gặp đúng vấn đề đua dữ liệu đã chứng minh ở [bài 4.2](../module-04-csharp-core/4.2-class-and-object.mdx).
