# 5.12 — Review and Assessment

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-05-advanced-csharp/5.12-review-and-assessment
> Ôn tập & tự đánh giá Advanced C#: refactor, LINQ thống kê, error handling và checklist trước khi sang module tiếp theo.
...
#### Bài 3 — Generic `PagedResult` và `Result` Error Handling
...
| Generics | `Repository`, `PagedResult`, `Result` là pattern dùng xuyên suốt app |
...
| Nullable Reference Types | Bật `enable` ngay từ đầu project, dùng `?` rõ ràng |
...
3. Nullable Reference Types (`enable`) giúp?
...
- **Bài trước:** [5.11 — Ví dụ thực tế nhanh](5.11-quick-real-world-example.mdx)
