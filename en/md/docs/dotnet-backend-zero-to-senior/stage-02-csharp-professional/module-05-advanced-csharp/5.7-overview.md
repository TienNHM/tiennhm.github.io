# 5.7 — 7. Expression Trees và Reflection (Overview)

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-05-advanced-csharp/5.7-overview
...
**Trimming** loại bỏ mã không được tham chiếu để giảm kích thước. **Native AOT** biên dịch thẳng sang mã máy lúc build, như đã nói ở [bài 2.10](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-02-computer-science-basics/2.9-dotnet-runtime-and-ecosystem).
...
Đây chính là khác biệt giữa `IQueryable` và `IEnumerable` mà [bài 5.4](5.3-linq.mdx) đo bằng câu SQL sinh ra:
