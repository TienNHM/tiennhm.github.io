# 5.8 — 8. Tuples và Deconstruction

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-05-advanced-csharp/5.8-tuples-and-deconstruction
...
Deconstruction ghép rất tốt với pattern matching ở [bài 4.9](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-04-csharp-core/4.8-pattern-matching):
...
Dòng thứ ba đáng chú ý: `ValueTuple` cài đặt sẵn `Equals` và `GetHashCode` theo giá trị, nên nó dùng làm khoá `Dictionary` được ngay — không gặp vấn đề đã nêu ở [bài 1.6](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-01-programming-logic/1.5-arrays-and-lists).
...
| Cần biểu diễn cả thành công lẫn lỗi có thông điệp | `Result` |
