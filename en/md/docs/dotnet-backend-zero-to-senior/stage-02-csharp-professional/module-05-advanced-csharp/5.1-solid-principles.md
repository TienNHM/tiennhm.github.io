# 5.1 — 1. SOLID Principles

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-05-advanced-csharp/5.1-solid-principles
...
Ba nguyên tắc cuối đã được đào ở Module 4: [Liskov ở bài 4.4](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-04-csharp-core/4.3-inheritance-and-polymorphism), còn [Interface Segregation và Dependency Inversion ở bài 4.5](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-04-csharp-core/4.4-interface). Bài này tập trung vào hai cái đầu và vào phần phê phán.
...
Đây là chỗ nối với cảnh báo ở [bài 4.6 về trừu tượng hoá quá sớm](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-04-csharp-core/4.5-abstraction).

### 5.2.4 — Ba nguyên tắc còn lại, tóm tắt

**L — Liskov:** lớp con phải dùng thay lớp cha được ở mọi chỗ, mà code gọi không cần biết. Ba dấu hiệu vi phạm: lớp con ném ngoại lệ cho phương thức cha hỗ trợ, lớp con override rồi không làm gì, và code gọi phải kiểm tra kiểu. Chi tiết kèm ví dụ hình vuông–hình chữ nhật ở [bài 4.4](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-04-csharp-core/4.3-inheritance-and-polymorphism).
...
Một `IFooService` chỉ có `FooService` cài đặt, không vượt ranh giới hạ tầng nào, không cần thay bằng bản giả — đó là nghi lễ. Ba câu hỏi quyết định nằm ở [bài 4.5](https://tiennhm.io.vn/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-04-csharp-core/4.4-interface).
