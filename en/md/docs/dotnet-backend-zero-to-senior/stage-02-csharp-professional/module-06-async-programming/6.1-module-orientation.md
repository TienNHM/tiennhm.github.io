...
> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-06-async-programming/6.1-module-orientation
> Định hướng Module 6 — Async programming: mục tiêu, thứ tự bài học và liên kết tới chương trước — chương sau trong lộ trình .NET backend.
...
### 6.1.1 — 6.1 — Liên kết điều phối (curriculum graph)
...
### 6.1.2 — 6.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 6.1.3 — 6.3 — Từ khóa chỉ mục (semantic hooks)
...
- Stream dữ liệu lớn với `IAsyncEnumerable`
- Xây dựng producer-consumer queue bằng `System.Threading.Channels`

---

### 6.1.6 — 6.6 — Câu hỏi khởi động
