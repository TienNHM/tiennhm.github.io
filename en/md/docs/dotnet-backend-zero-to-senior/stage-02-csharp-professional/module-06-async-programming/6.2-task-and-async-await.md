...
3. **`MoveNext` là thứ bạn thấy trong dấu vết ngăn xếp.** Khi đọc log lỗi và gặp `at Crm.Services.OrderService.d__0.MoveNext()`, giờ bạn biết đó là gì: máy trạng thái của phương thức `XuLyAsync`, chứ không phải một lỗi lạ.
