# 6.12 — Review and Assessment

> Nguồn: https://tiennhm.io.vn/en/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-06-async-programming/6.12-review-and-assessment
> Ôn tập & tự đánh giá Async Programming với CancellationToken, WhenAll/timeout, async streaming và checklist trước khi sang module tiếp theo.
...
**Yêu cầu:**
1. Đổi tất cả method sang `async Task`
...
- **Bài trước:** [6.11 — Ví dụ thực tế nhanh](6.11-quick-real-world-example.mdx)
