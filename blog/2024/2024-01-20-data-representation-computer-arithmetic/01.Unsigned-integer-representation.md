...
Nắm được biểu diễn nhị phân rồi thì các bài [thao tác trên bit](/docs/leetcode/bit-manipulation/191-number-of-1-bits) trong phần LeetCode là chỗ luyện trực tiếp: đếm bit 1, đếm bit cho mọi số từ 0 tới n.
