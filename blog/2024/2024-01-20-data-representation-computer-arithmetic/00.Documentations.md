...
Đây là nền cho mọi thao tác ở mức bit; phần [bit manipulation](/docs/leetcode/bit-manipulation/191-number-of-1-bits) trong mục LeetCode là chỗ áp dụng trực tiếp những gì đọc ở đây.
...
- [191. Number of 1 Bits](/docs/leetcode/bit-manipulation/191-number-of-1-bits) — Write a function that takes the binary representation of an unsigned integer and returns the number of `1` bits it has (also known as the Hamming…
