...
- [2.3 — 1. Internet hoạt động như thế nào](/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-02-computer-science-basics/2.2-how-the-internet-works) — Theo chân một request từ lúc gõ URL tới lúc pixel hiện lên: DNS, TCP, TLS, HTTP.
