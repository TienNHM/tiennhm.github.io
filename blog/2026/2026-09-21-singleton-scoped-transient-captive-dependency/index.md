...
- [7.10 — 8. Anti-patterns](/docs/dotnet-backend-zero-to-senior/stage-02-csharp-professional/module-07-dependency-injection/7.10-anti-patterns) — Anti-patterns: Service Locator (tại sao xấu); Ambient Context; Over-injection — dấu hiệu God Service.
