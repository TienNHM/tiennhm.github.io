...
description: SOLID, LINQ, delegate/event, extension, reflection, generics, expression trees, nullable reference types.
sidebar_position: 2
tags: [dotnet, csharp, solid, linq]
keywords: [solid, linq, generics, nullable-reference-types]
enableComments: true
draft: false
---
...
<SummaryBox>
Module 5 nâng kỹ năng C# từ "chạy được" lên "production-ready": áp dụng SOLID để thiết kế CRM service layer, khai thác Generics và LINQ để query/thống kê Lead/Deal, sử dụng delegate/event cho domain notification, viết extension method tiện lợi, và làm chủ Nullable Reference Types để triệt tiêu NullReferenceException ngay từ compile time.
</SummaryBox>
