---
title: "4.8 — 8. Pattern Matching (C# 8+)"
...
**1. Một biểu thức `switch` dài hơn 15 nhánh.** Nó đã thành một bảng dữ liệu viết nhầm thành code — xem lại [bài 1.3](/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-01-programming-logic/1.2-conditions).
...
Tiêu chí phân biệt: nếu các nhánh **thuộc về chính đối tượng đó** thì dùng đa hình như [bài 4.4](4.3-inheritance-and-polymorphism.mdx). Nếu chúng thuộc về **người gọi** — ví dụ cách hiển thị khác nhau ở từng màn hình — thì pattern matching đúng hơn, vì bạn không muốn nhồi logic hiển thị vào entity.
...
Lúc này đặt tên cho ý nghĩa là cách tốt hơn, đúng như [bài 1.5](../../stage-01-foundation/module-01-programming-logic/1.4-functions-methods.mdx) đã nêu:
...
- **Bài trước:** [4.7 — 7. Records và Value Objects (C# 9+)](4.7-records-and-value-objects.mdx)
- **Bài tiếp theo:** [4.9 — Những lỗi thường gặp](4.9-common-mistakes.mdx)
