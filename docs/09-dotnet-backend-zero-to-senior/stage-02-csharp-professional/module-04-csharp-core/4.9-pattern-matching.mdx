...
3. **Kiểu kín, và thao tác thì mở.** Với hệ thống kiểu kín như `Result<T>` — chỉ có hai khả năng là thành công hoặc thất bại, và sẽ không bao giờ có khả năng thứ ba — thì số kiểu cố định còn số thao tác thì tăng dần. Pattern matching hợp hơn, và trình biên dịch vẫn kiểm tra vét cạn giúp bạn.
