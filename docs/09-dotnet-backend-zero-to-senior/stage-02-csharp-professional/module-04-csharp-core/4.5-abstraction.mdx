...
3. **Ánh xạ sang mã HTTP trở nên tự nhiên.** Tầng API bắt `DuplicateEmailException` và trả `409 Conflict`, không cần biết gì về database:
   ...
   [Bài 8.9](../../stage-03-aspnet-core-backend/module-08-aspnet-core-fundamentals/8.8-global-exception-handling.mdx) trình bày cách cài đặt ánh xạ này một lần cho toàn ứng dụng.
...
- Đảo chiều phụ thuộc như bài 1 ở [bài 4.5](4.4-interface.mdx) đã phân tích.
...
- **Bài trước:** [4.4 — 4. Interface](4.4-interface.mdx)
- **Bài tiếp theo:** [4.6 — 6. Access Modifiers](4.6-access-modifiers.mdx)
