...
1. **Chứng minh bẫy collection.** Tạo `record Order(int Id, List<string> Tags)`, tạo hai instance cùng nội dung, so sánh bằng `==`. Ghi lại kết quả. Đổi `List` thành `ImmutableArray` và so sánh lại.
