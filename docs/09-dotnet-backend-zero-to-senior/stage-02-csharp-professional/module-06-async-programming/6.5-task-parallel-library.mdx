---
title: "6.5 — 4. Task Parallel Library"
...
`Parallel.ForEach` nhận `Action<T>`, nên lambda `async` ở đây trở thành **`async void`** (xem [bài 6.3](6.2-task-and-async-await.mdx)): vòng lặp "xong" ngay lập tức trong khi công việc còn đang chạy, và mọi exception làm sập tiến trình.
