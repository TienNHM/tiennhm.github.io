...
**Lợi ích của việc bỏ `await` có đáng không.** Nó tiết kiệm đúng một máy trạng thái, tức khoảng **48 nano-giây** theo số đo ở [bài 6.2](6.2-why-async-matters.mdx). Đổi lại là một lớp lỗi khó tìm. Khuyến nghị: **giữ `await` cho tới khi đo được rằng nó là nút thắt** — và với code backend thông thường, nó sẽ không bao giờ là nút thắt.
