...
description: "Người dùng bấm \"Hủy\" trên form CRM, hoặc request HTTP timeout sau 30s. Nếu không có CancellationToken, server vẫn tiếp tục chạy query DB 10 phút → lãng phí."
sidebar_position: 5
---
