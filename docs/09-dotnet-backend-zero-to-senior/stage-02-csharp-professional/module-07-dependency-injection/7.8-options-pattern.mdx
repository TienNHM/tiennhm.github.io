...
2. **Captive options.** Tiêm `IOptionsSnapshot<T>` vào một Singleton, sửa `appsettings.json` khi ứng dụng đang chạy và xác nhận giá trị **không** đổi. Chuyển sang `IOptionsMonitor<T>` và xác nhận nó đổi.
