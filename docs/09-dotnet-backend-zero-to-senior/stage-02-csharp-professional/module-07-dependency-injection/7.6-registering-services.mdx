...
- **Constructor injection an toàn hơn** không chỉ vì rõ ràng hơn, mà vì nó **kiểm chứng được tự động**. Đây là một lý do nữa để ưu tiên nó, bên cạnh các lý do ở [bài 7.4](7.4-three-ways-register-services.mdx).
