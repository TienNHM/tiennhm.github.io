---
title: "7.10 — Mở rộng và đào sâu"
description: "Decorator qua DI, factory pattern, module đăng ký, Scrutor và container bên thứ ba — những kỹ thuật DI nâng cao."
sidebar_position: 10
---
...
| Nhiều cài đặt cho một interface | Có (`IEnumerable<T>`) | Không |
...
<Checklist
  title="Danh sách rà soát DI nâng cao"
  items={[
    { text: "Caching và logging thêm bằng decorator, không sửa service gốc." },
    { text: "Không tiêm IServiceProvider trực tiếp vào service nghiệp vụ." },
    { text: "Factory có interface rõ ràng thay vì service locator." },
    { text: "Đăng ký service gom theo module, Program.cs ngắn gọn." },
    { text: "Mỗi module tự chứa cả đăng ký service lẫn cấu hình Options." },
    { text: "Quét theo quy ước chỉ dùng cho nhóm lớp đồng nhất." },
    { text: "Đã cân nhắc kỹ trước khi thêm container bên thứ ba." },
  ]}
/>
...
<FAQSection
  items={[
    {
      question: "Decorator giải quyết vấn đề gì?",
      answer: "Nó cho phép thêm caching, logging hay retry vào một service mà không sửa dòng nào của service đó. Service gốc vẫn đơn giản, bỏ hành vi thêm vào chỉ là xoá một dòng đăng ký, và test của cả hai đều đơn giản."
    },
    {
      question: "Thứ tự đăng ký decorator ảnh hưởng thế nào?",
      answer: "Lệnh Decorate gọi sau sẽ bọc ngoài cùng. Nếu đăng ký cache trước rồi log sau, log sẽ ghi lại cả những lần cache hit, thường là điều bạn muốn."
    },
    {
      question: "Vì sao tiêm IServiceProvider vào service nghiệp vụ là anti-pattern?",
      answer: "Vì nó giấu dependency thật, khiến đọc constructor không biết lớp cần gì, và làm test khó vì phải dựng cả container. Bọc nó trong một factory có interface rõ ràng thì chấp nhận được."
    },
    {
      question: "Lợi ích ngoài khả năng đọc của module đăng ký là gì?",
      answer: "Mỗi module tự chứa mọi thứ nó cần gồm cả đăng ký service lẫn cấu hình Options, nên việc tách module thành service riêng sau này dễ hơn nhiều."
    },
    {
      question: "Đánh đổi của việc quét assembly theo quy ước là gì?",
      answer: "Bạn không còn thấy service nào được đăng ký khi đọc Program.cs, nên khi có lỗi không tìm thấy service thì khó chẩn đoán hơn vì không có dòng nào để đặt breakpoint."
    },
    {
      question: "Còn lý do nào để dùng container bên thứ ba không?",
      answer: "Chỉ còn property injection và interception động. Nhưng property injection giấu dependency và làm đối tượng có thể tồn tại ở trạng thái chưa đủ điều kiện, còn interception động làm luồng thực thi khó theo dõi hơn decorator tường minh."
    }
  ]}
/>
