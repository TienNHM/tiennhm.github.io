...
**Trimming** loại bỏ mã không được tham chiếu để giảm kích thước. **Native AOT** biên dịch thẳng sang mã máy lúc build, như đã nói ở [bài 2.10](/docs/dotnet-backend-zero-to-senior/stage-01-foundation/module-02-computer-science-basics/2.10-dotnet-runtime-and-ecosystem).
...
Đây chính là khác biệt giữa `IQueryable<T>` và `IEnumerable<T>` mà [bài 5.4](5.4-linq.mdx) đo bằng câu SQL sinh ra:
