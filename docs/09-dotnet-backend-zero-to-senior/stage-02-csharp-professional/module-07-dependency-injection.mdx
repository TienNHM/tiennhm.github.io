...
**Abstract.** Trình bày **đảo nghịch điều khiển (IoC)** và triển khai qua `Microsoft.Extensions.DependencyInjection`: vòng đời dịch vụ, cấu hình, **composition root** — căn chỉnh với pipeline `WebApplication` và chiến lược kiểm thử.
...
- **Chương trước**: [Module 6 — Async Programming](module-06-async-programming.mdx)
