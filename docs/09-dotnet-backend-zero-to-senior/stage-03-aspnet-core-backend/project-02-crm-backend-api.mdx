...
- **Chương trước**: [Module 11 — SignalR](module-11-signalr.mdx)
- **Chương tiếp theo**: [Module 12 — SQL Deep Dive](../stage-04-database-production/module-12-sql-deep-dive.mdx)
...
|-----|---------------------------|
| **Trước** | [Module 11 — SignalR](module-11-signalr.mdx) |
| **Tiếp theo** | [Module 12 — SQL Deep Dive](../stage-04-database-production/module-12-sql-deep-dive.mdx) |
