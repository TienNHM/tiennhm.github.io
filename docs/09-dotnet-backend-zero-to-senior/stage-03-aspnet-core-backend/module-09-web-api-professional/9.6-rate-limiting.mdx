...
flowchart TB
    ...
    B["Sliding Window<br/>Chia cửa sổ thành đoạn<br/>Mượt hơn — tốn bộ nhớ hơn"]
    C["Token Bucket<br/>Token nạp dần, mỗi request tiêu 1<br/>Cho phép burst có kiểm soát"]
    D["Concurrency<br/>Giới hạn SỐ REQUEST ĐỒNG THỜI<br/>Không liên quan thời gian"]
```
...
=> Hạn mức thực tế: 400 request/phút
=> Và người dùng bị chặn hay không phụ thuộc vào pod nào nhận request
```
