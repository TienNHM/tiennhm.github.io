...
description: "User click \"Đăng nhập bằng Google\" → redirect sang Google → Google trả về code → server đổi code lấy idtoken → tạo/map user trong DB → phát JWT nội bộ."
sidebar_position: 10
---
