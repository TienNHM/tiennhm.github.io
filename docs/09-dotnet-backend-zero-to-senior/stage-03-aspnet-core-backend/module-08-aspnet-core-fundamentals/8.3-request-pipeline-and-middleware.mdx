...
**Gợi ý.** Nhớ lại cấu trúc một phản hồi HTTP ở [bài 2.5](../../stage-01-foundation/module-02-computer-science-basics/2.5-http-https.mdx): dòng trạng thái, rồi header, rồi dòng trống, rồi body. Thứ tự đó là thứ tự **trên đường truyền**.
...
{
    _metrics.GhiNhan(sw.ElapsedMilliseconds);      // chỉ đo lường, không đụng header
    return Task.CompletedTask;
});
```
