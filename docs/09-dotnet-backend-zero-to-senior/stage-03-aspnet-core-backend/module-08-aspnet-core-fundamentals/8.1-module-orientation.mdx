...
### 8.1 — Liên kết điều phối (curriculum graph)
...
### 8.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 8.3 — Từ khóa chỉ mục (semantic hooks)
