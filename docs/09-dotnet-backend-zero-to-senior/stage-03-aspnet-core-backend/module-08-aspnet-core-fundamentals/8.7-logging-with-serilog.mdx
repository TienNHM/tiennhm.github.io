---
title: "8.7 — 7. Logging với Serilog"
...
Đặt nó **sớm** trong pipeline, ngay sau middleware xử lý lỗi và correlation ID ([bài 8.3](8.2-request-pipeline-and-middleware.mdx)).
...
- **Bài trước:** [8.6 — 6. Configuration System](8.6-configuration-system.mdx)
- **Bài tiếp theo:** [8.8 — 8. Global Exception Handling](8.8-global-exception-handling.mdx)
