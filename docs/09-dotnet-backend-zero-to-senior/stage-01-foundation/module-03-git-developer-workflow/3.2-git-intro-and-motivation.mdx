...
Đây chính là nội dung của luật vàng ở [bài 3.6](3.6-branching-and-merging.mdx): **viết lại lịch sử thoải mái trên nhánh chưa ai dùng, không bao giờ trên nhánh đã chia sẻ.**
...
git commit -m "feat: them truong ghi chu cho khach hang"

# Commit việc B
git add README.md
git commit -m "docs: cap nhat huong dan chay project"
```
