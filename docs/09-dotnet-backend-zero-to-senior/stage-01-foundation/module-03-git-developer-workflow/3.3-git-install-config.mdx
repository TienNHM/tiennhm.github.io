...
User secrets lưu ngoài thư mục dự án nên không có đường nào lọt vào Git. [Bài 8.7](../../stage-03-aspnet-core-backend/module-08-aspnet-core-fundamentals/8.7-configuration-system.mdx) trình bày thứ tự ưu tiên giữa các nguồn cấu hình.
