...
2. **Xung đột ngữ nghĩa tích tụ.** Loại xung đột mà Git không thấy ([bài 3.8](3.8-git-conflicts.mdx)) sinh ra càng nhiều khi khoảng cách càng lớn, và chúng chỉ lộ ra lúc build hoặc lúc chạy.
