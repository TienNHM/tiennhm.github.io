...
Quy ước đặt tên loại (`feat`, `fix`, `refactor`...) là chủ đề của [bài 3.11 Conventional Commits](3.10-conventional-commits.mdx).
...
```bash
git commit -m "chore: add log when fetching a customer"
...
Mỗi bước giữ hệ thống ở trạng thái chạy được, nên mỗi bước đều gỡ lại được độc lập. Đây cũng là cách triển khai không gián đoạn mà [bài 12.9](../../stage-04-database-production/module-12-sql-deep-dive/12.8-database-migration-strategy.mdx) trình bày đầy đủ.
...
- **Bài trước:** [3.3 — Checklist an toàn khi làm Git](3.3-git-safety-checklist.mdx)
- **Bài tiếp theo:** [3.5 — 4. Branching và Merging](3.5-branching-and-merging.mdx)
