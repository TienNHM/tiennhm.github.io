...
1. **Chia theo tầng.** Migration database thành một PR, tầng nghiệp vụ một PR, API một PR. Mỗi PR merge được độc lập nếu dùng mẫu mở rộng rồi thu hẹp ở [bài 3.5](3.4-basic-git-workflow.mdx).
