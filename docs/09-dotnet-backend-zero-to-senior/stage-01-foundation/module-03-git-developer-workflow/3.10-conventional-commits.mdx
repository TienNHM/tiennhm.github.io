---
title: "3.10 — 9. Conventional Commits"
...
```mermaid
flowchart LR
    A[Commit theo quy ước] --> B[Sinh CHANGELOG]
    A --> C[Tăng số phiên bản tự động]
    A --> D[Lọc lịch sử theo loại]
```
...
- **Bài trước:** [3.9 — 8. Debugging Workflow](3.9-debugging-workflow.mdx)
- **Bài tiếp theo:** [3.11 — Mở rộng và đào sâu](3.11-advanced-notes.mdx)
