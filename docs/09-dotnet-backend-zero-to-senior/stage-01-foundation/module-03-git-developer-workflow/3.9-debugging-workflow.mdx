...
Đây là lý do **mỗi commit phải build được** như [bài 3.5](3.4-workflow-co-ban.mdx) đã nói. Một commit hỏng build nằm giữa dải tìm kiếm làm hỏng cả quy trình.
