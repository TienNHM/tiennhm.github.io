...
- **SDK vs Runtime**: SDK = công cụ để build (bao gồm compiler, CLI); Runtime = môi trường chạy app (nhỏ hơn, dành cho server production)
...
| .NET Ecosystem       | .NET 8, CLR, SDK vs Runtime, NuGet, cấu trúc solution nhiều project      |
