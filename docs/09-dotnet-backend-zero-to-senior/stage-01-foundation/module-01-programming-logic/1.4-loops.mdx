...
**Liên hệ về sau.** Đây chính là ý tưởng nền của `IAsyncEnumerable` mà [Module 6 bài 6.7](../../stage-02-csharp-professional/module-06-async-programming/6.7-async-patterns.mdx) dùng để stream dữ liệu lớn qua API mà không làm phình bộ nhớ máy chủ.
