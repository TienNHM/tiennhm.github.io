...
<Checklist
  ...
  items={[
    { text: "Đã cài .NET SDK 8 trở lên. Kiểm tra bằng `dotnet --version`, phải in ra số phiên bản chứ không phải lỗi." },
    { text: "Tạo và chạy được một project rỗng: `dotnet new console -o Thu && cd Thu && dotnet run` in ra `Hello, World!`." },
    ...
    { text: "Biết mở terminal và di chuyển thư mục bằng `cd`." },
