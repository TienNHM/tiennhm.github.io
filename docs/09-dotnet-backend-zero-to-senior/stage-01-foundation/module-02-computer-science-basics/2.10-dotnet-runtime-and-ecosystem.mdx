...
2. **Request đầu tiên sau khi triển khai luôn chậm.** Người dùng xui xẻo nhận được nó. Cách xử lý là gửi vài request làm nóng trước khi đưa thể hiện mới vào vòng phục vụ — phần readiness probe ở [bài 2.9](2.9-hosting-and-cloud-co-ban.mdx) chính là chỗ móc vào.
