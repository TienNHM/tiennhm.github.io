...
```mermaid
flowchart LR
    A[Mã nguồn C#] -->|Roslyn| B[IL trong file .dll]
    B -->|JIT lúc chạy| C[Mã máy cho CPU hiện tại]
    B -->|AOT lúc build| D[Mã máy đóng gói sẵn]
```
...
2. **Request đầu tiên sau khi triển khai luôn chậm.** Người dùng xui xẻo nhận được nó. Cách xử lý là gửi vài request làm nóng trước khi đưa thể hiện mới vào vòng phục vụ — phần readiness probe ở [bài 2.9](2.8-hosting-and-cloud-basics.mdx) chính là chỗ móc vào.
...
- **Bài trước:** [2.8 — 7. Hosting và Cloud cơ bản](2.8-hosting-and-cloud-basics.mdx)
