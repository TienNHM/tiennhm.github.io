---
title: "2.11 — Mini case study"
description: "Người dùng báo đăng nhập được nhưng mọi trang khác báo 401: lần theo một request từ trình duyệt tới database để tìm nguyên nhân."
sidebar_position: 11
---
...
<Checklist
  title="Danh sách rà soát khi chẩn đoán lỗi web"
  items={[
    { text: "Đã xem DevTools Network trước khi đọc code." },
    { text: "Đã xác nhận request có tới server và có kèm header cần thiết." },
    { text: "Đã dùng curl để loại trừ yếu tố trình duyệt." },
    { text: "Đã đọc kỹ thông điệp lỗi trong header phản hồi, không chỉ mã trạng thái." },
    { text: "Đã kiểm tra những thứ ngoài code: đồng hồ, biến môi trường, chứng chỉ." },
    { text: "Đã hỏi cái gì vừa thay đổi gần đây nhất." },
    { text: "Kiểm tra theo thứ tự từ ngoài vào trong, không nhảy cóc." },
    { text: "Sau khi sửa, đã thêm cảnh báo để lần sau hệ thống tự báo." },
  ]}
/>
...
<FAQSection
  items={[
    {
      question: "Vì sao nên kiểm tra từ ngoài vào trong?",
      answer: "Vì mỗi chặng loại trừ được là bớt một nửa phạm vi tìm kiếm. Nhảy thẳng vào đọc code backend khi chưa biết request có tới đó không là cách tốn thời gian nhất."
    },
    {
      question: "DevTools Network cho biết những gì trong ca này?",
      answer: "Rằng DNS và HTTPS không phải vấn đề vì request đã tới server và nhận được phản hồi, và rằng frontend có gửi header Authorization. Hai kết luận đó loại trừ được hai chặng đầu ngay lập tức."
    },
    {
      question: "Vì sao dùng curl thay vì chỉ thử trên trình duyệt?",
      answer: "Vì curl loại bỏ mọi yếu tố của trình duyệt như cache, cookie, extension và CORS. Nếu curl cho kết quả khác trình duyệt thì vấn đề nằm ở phía trình duyệt chứ không phải server."
    },
    {
      question: "Vì sao lệch đồng hồ làm token vừa cấp đã hết hạn?",
      answer: "Vì JWT chứa exp là mốc thời gian tuyệt đối, và bên kiểm tra so nó với đồng hồ của mình. Nếu đồng hồ trôi nhanh hơn giữa lúc cấp và lúc kiểm tra, và độ trôi lớn hơn khoảng dung sai cho phép, token sẽ bị coi là hết hạn."
    },
    {
      question: "Thông tin nào trong triệu chứng ban đầu giúp thu hẹp phạm vi nhất?",
      answer: "Rằng lỗi xảy ra với mọi người dùng, nên không phải vấn đề tài khoản cá nhân, và rằng nó mới bắt đầu hôm nay, nên có gì đó vừa thay đổi. Hai thông tin đó hướng ngay tới thay đổi hệ thống chứ không phải bug code."
    },
    {
      question: "Nên làm gì sau khi sửa xong sự cố kiểu này?",
      answer: "Thêm kiểm tra đồng bộ thời gian vào health check, để lần sau hệ thống tự báo thay vì chờ người dùng phát hiện. Mỗi sự cố nên để lại một cảnh báo mới."
    }
  ]}
/>
