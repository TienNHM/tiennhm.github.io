...
`EnableIdempotence` đáng bật vì nó chống trùng do producer retry, nhưng nó **không** thay thế idempotency ở consumer. Với hệ thống .NET điển hình ghi vào SQL Server, bạn vẫn cần inbox hoặc unique constraint ([bài 17.2](17.2-messaging-fears-lost-duplicates.mdx)).
...
2. **Idempotency ở consumer** ([bài 17.2](17.2-messaging-fears-lost-duplicates.mdx)).
3. **Retry có jitter và DLQ có người theo dõi** ([bài 17.6](17.6-retry-and-backoff.mdx)).
