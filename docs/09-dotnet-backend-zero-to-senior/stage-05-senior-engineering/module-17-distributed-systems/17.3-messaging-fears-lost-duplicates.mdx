...
| **Outbox pattern** | Ghi message vào **cùng database** trong **cùng transaction**, worker đọc ra và publish sau | **Cách chuẩn** — xem [bài 17.4](17.4-outbox-pattern-applied.mdx) |
...
Xoá theo lô để không khoá bảng lâu, và chạy định kỳ bằng job nền ([bài 14.7](../../stage-04-database-production/module-14-caching-background-jobs/14.7-hangfire-background-jobs.mdx)).
