...
### 17.1 — Liên kết điều phối (curriculum graph)
...
### 17.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 17.3 — Từ khóa chỉ mục (semantic hooks)
