---
title: "17.13 — Ví dụ thực tế nhanh"
description: "Queue dồn 400.000 message trong 20 phút vì một consumer chậm: chẩn đoán prefetch, số consumer và poison message chỉ với ba chỉ số."
sidebar_position: 13
---
...
<Checklist
  title="Danh sách rà soát queue dồn"
  items={[
    { text: "PrefetchCount không bị đặt bằng 1 mà không có lý do rõ ràng." },
    { text: "ConcurrentMessageLimit đặt theo khả năng thật của consumer." },
    { text: "Consumer idempotent trước khi tăng mức song song." },
    { text: "Đã kiểm tra database chịu được số truy vấn song song sau khi scale." },
    { text: "Có cảnh báo khi số consumer bằng 0." },
    { text: "Cảnh báo dựa trên xu hướng và tuổi message, không chỉ số lượng." },
    { text: "Tự co giãn theo độ sâu queue, không theo CPU." },
    { text: "Đã đo thông lượng thật của consumer bằng test tải." },
    { text: "Có DLQ và cảnh báo trên DLQ để bắt poison message." },
  ]}
/>
...
<FAQSection
  items={[
    {
      question: "Ba chỉ số nào đủ để chẩn đoán queue dồn?",
      answer: "Tổng số message đang chờ, số message chưa được xác nhận tức đang xử lý, và số consumer đang gắn. Ba con số này đối chiếu với bảng chẩn đoán cho ra năm nguyên nhân phổ biến."
    },
    {
      question: "Tổ hợp nào cho thấy thiếu consumer hoặc prefetch quá nhỏ?",
      answer: "Số message chờ rất cao nhưng số message đang xử lý rất thấp và số consumer ít. Nó nghĩa là consumer chỉ nhận một hoặc vài message một lúc nên không thể rút kịp."
    },
    {
      question: "Tổ hợp nào cho thấy poison message?",
      answer: "Số message chờ cao, số đang xử lý dao động, và message liên tục quay lại queue. Nhìn qua trông như consumer đang làm việc nhưng thực ra nó xử lý cùng một message mãi mãi."
    },
    {
      question: "Điều kiện tiên quyết trước khi tăng mức song song là gì?",
      answer: "Consumer phải idempotent, vì xử lý song song làm tăng khả năng hai message liên quan chạy đồng thời và va vào nhau. Ngoài ra phải kiểm tra database chịu được số truy vấn song song mới."
    },
    {
      question: "Vì sao cảnh báo theo ngưỡng tuyệt đối là sai?",
      answer: "Vì nó báo động giả vào lúc cao điểm bình thường và im lặng khi một consumer duy nhất chết trong lúc lưu lượng thấp. Cảnh báo theo xu hướng và theo tuổi message cũ nhất phản ánh đúng vấn đề hơn."
    },
    {
      question: "Vì sao tự co giãn theo CPU không phù hợp với consumer?",
      answer: "Vì consumer chờ I/O có CPU rất thấp ngay cả khi queue đang dồn hàng trăm nghìn message. Co giãn theo độ sâu queue phản ánh đúng khối lượng công việc còn lại."
    }
  ]}
/>
