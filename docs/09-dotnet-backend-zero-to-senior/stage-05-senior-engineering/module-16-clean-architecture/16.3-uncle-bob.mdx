...
Điều này cũng giải thích vì sao `IRepository<T>` generic thường gây hại ([bài 13.9](../../stage-04-database-production/module-13-entity-framework-core/13.9-unit-of-work-and-repository-pattern.mdx)): nó áp cùng một mức trừu tượng cho cả đọc và ghi, trong khi hai bên có nhu cầu ngược nhau.
