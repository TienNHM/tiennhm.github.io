...
Test này chạy trong **micro giây**, không cần gì cả, và nó bảo vệ một quy tắc nghiệp vụ thật. Đây là loại test đáng viết nhiều nhất — và nó **chỉ viết được** nếu Domain tách khỏi hạ tầng ([bài 16.4](16.4-uncle-bob.mdx)).
...
Dùng Testcontainers để có database thật ([bài 9.9](../../stage-03-aspnet-core-backend/module-09-web-api-professional/9.9-api-testing.mdx)). Test này chậm hơn (trăm mili giây) nhưng bắt được: ràng buộc database, truy vấn không dịch được, cấu hình EF Core sai, và lỗi transaction.
...
**4. Ranh giới tích hợp.** Endpoint danh sách có phân trang, quyền, và lọc — nơi dễ sai nhất ([bài 10.7](../../stage-03-aspnet-core-backend/module-10-authentication-authorization/10.7-resource-based-authorization.mdx)).
