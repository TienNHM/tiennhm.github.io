...
Codebase muc:   tinh nang thu 100 = 10x tinh nang thu 10
```
...
```csharp
// Thang 6 — moi dong them vao deu "hop ly"
[HttpPost]
public async Task<IActionResult> Create(CreateLeadRequest request, CancellationToken ct)
{
...
Đó là toàn bộ nội dung của **dependency rule** ở [bài 16.4](16.4-uncle-bob.mdx), và cũng là lý do [Module 7](../../stage-02-csharp-professional/module-07-dependency-injection/) nhấn mạnh việc entity không nên biết gì về EF Core.
