...
```
# Cat NGANG — mot tinh nang nam rai 4 thu muc
src/
...
Handler tự truy vấn database, tự gọi API ngoài, tự gửi email, tự ghi audit — và file 600 dòng. Nó lại là cái controller khổng lồ ở [bài 16.2](16.2-vi-sao-crm-to-ra-la-luc-kien-truc-tra-gia.mdx), chỉ đổi tên thư mục.
...
```
src/
├── Crm.Domain/              <- entity, VO, bat bien. KHONG reference gi.
├── Crm.Application/
│   └── Features/
│       ├── Leads/CreateLead.cs
...
Và với đường đọc, slice dùng thẳng `DbContext` — đúng thoả hiệp mức 2 ở [bài 16.4](16.4-uncle-bob.mdx).
