...
Ba điều FluentValidation làm tốt hơn DataAnnotations ([bài 8.6](../../stage-03-aspnet-core-backend/module-08-aspnet-core-fundamentals/8.6-model-validation.mdx)):
...
Và **ràng buộc `UNIQUE` vẫn là hàng rào cuối** ([bài 12.2](../../stage-04-database-production/module-12-sql-deep-dive/12.2-crm-database-design.mdx)):
...
Giữ nguyên `ValidationProblemDetails` để client sinh tự động parse được ([bài 8.6](../../stage-03-aspnet-core-backend/module-08-aspnet-core-fundamentals/8.6-model-validation.mdx)).
...
Và **một validator mỗi command**. Validator dùng chung cho nhiều command tạo ghép chặt giống như DTO dùng chung ở [bài 16.5](16.5-vertical-slice-architecture.mdx).
