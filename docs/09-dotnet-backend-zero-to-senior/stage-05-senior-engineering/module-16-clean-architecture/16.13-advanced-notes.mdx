---
title: "16.13 — Mở rộng và đào sâu"
description: "Specification pattern, Result thay exception, Value Object nâng cao, Marten và event sourcing — điều kiện để mỗi thứ đáng dùng."
sidebar_position: 13
---
...
<Checklist
  title="Danh sách rà soát mẫu nâng cao"
  items={[
    { text: "Lỗi nghiệp vụ trả về Result, không ném exception." },
    { text: "Exception chỉ dùng cho lỗi lập trình và vi phạm invariant." },
    { text: "Id của entity dùng kiểu riêng, không dùng Guid thuần." },
    { text: "Khái niệm nghiệp vụ có quy tắc được bọc thành value object." },
    { text: "Value object ánh xạ bằng complex property hoặc converter phù hợp." },
    { text: "Điều kiện lọc lặp từ ba nơi trở lên được gom thành specification." },
    { text: "Lọc theo tenant dùng global query filter, không dùng specification." },
    { text: "Đã cân nhắc bảng audit log trước khi nghĩ tới event sourcing." },
  ]}
/>
...
| | Exception | `Result` |
|---|---|---|
| Xuất hiện trong chữ ký | **Không** — người gọi không biết | **Có** — `Task<Result>` |
...
<FAQSection
  items={[
    {
      question: "Vì sao lỗi nghiệp vụ không nên dùng exception?",
      answer: "Vì lỗi nghiệp vụ không phải trường hợp ngoại lệ. Số dư không đủ là kết quả bình thường và dự kiến được của việc rút tiền. Dùng exception làm chữ ký phương thức nói dối về những gì nó có thể trả về, và ném exception cũng tốn kém hơn trả về giá trị."
    },
    {
      question: "Ranh giới giữa Result và exception là gì?",
      answer: "Lỗi mà người dùng có thể sửa bằng cách nhập lại thì dùng Result. Lỗi mà lập trình viên phải sửa, như tham số null hay vi phạm invariant trong domain, thì dùng exception."
    },
    {
      question: "Khi nào Specification pattern bị lạm dụng?",
      answer: "Khi dùng cho truy vấn chỉ xuất hiện một lần, vì khi đó LINQ thẳng ngắn gọn và dễ đọc hơn. Và nếu điều kiện là bảo mật như lọc theo tenant thì global query filter chặt chẽ hơn vì nó không thể bị quên."
    },
    {
      question: "Vì sao complex property tốt hơn owned entity cho value object?",
      answer: "Vì value object được đối xử đúng như giá trị chứ không phải entity có định danh, nên tránh được các vấn đề về change tracking mà owned entity đôi khi gây ra."
    },
    {
      question: "Strongly-typed ID giải quyết bug gì?",
      answer: "Truyền nhầm id giữa các loại entity. Khi mọi id đều là Guid, trình biên dịch không phát hiện được việc truyền customerId vào chỗ cần leadId, và bug đó rất khó tìm lúc chạy."
    },
    {
      question: "Hai mẫu nào nên làm ngay từ dự án mới?",
      answer: "Result cho lỗi nghiệp vụ và strongly-typed ID. Cả hai đều rẻ để áp dụng từ đầu, trong khi sửa lại sau khi codebase đã lớn thì đắt hơn nhiều."
    }
  ]}
/>
