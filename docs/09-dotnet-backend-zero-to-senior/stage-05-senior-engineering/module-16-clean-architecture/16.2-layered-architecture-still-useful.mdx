...
**Nhưng đừng tách project quá sớm.** Bốn project cho một CRUD 10 bảng là chi phí thuần ([bài 16.2](16.1-vi-sao-crm-to-ra-la-luc-kien-truc-tra-gia.mdx)). Bắt đầu bằng thư mục, chuyển sang project khi ranh giới **đã rõ** và kỷ luật **đã bắt đầu thất bại**.
...
- **Bài trước:** [16.1 — 1. Vì sao CRM “to ra” là lúc kiến trúc trả giá?](16.1-vi-sao-crm-to-ra-la-luc-kien-truc-tra-gia.mdx)
