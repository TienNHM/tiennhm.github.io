---
title: "18.9 — Liên hệ CRM"
description: "Bốn service tách được trong CRM/ERP và lý do, định tuyến theo tenant ở gateway, và ba ranh giới nên giữ nguyên trong monolith."
sidebar_position: 9
---
...
<Checklist
  title="Danh sách rà soát microservices trong CRM"
  items={[
    { text: "Lead, Customer và Deal nằm cùng một service." },
    { text: "Không có thực thể nào thay đổi cùng transaction lại bị tách service." },
    { text: "Notification và Reporting là ứng viên tách trước lõi nghiệp vụ." },
    { text: "Mọi tích hợp bên thứ ba gom vào một chỗ, không rải vào lõi." },
    { text: "Header tenant chỉ dùng để định tuyến, phân quyền lấy từ claim đã ký." },
    { text: "Mỗi service tự áp lọc theo tenant, không tin gateway đã lọc." },
    { text: "Dữ liệu người dùng nhân bản chỉ gồm trường cần hiển thị." },
    { text: "Vai trò và quyền không được nhân bản, luôn hỏi Identity." },
    { text: "readiness chỉ gồm phụ thuộc bắt buộc, không gồm phụ thuộc tuỳ chọn." },
  ]}
/>
...
<FAQSection
  items={[
    {
      question: "Vì sao Notification là ứng viên tách tốt nhất?",
      answer: "Vì nó ít phụ thuộc, chỉ cần biết gửi cho ai và nội dung gì, có nhu cầu scale khác hẳn phần còn lại do đỉnh tải theo giờ, và nếu hỏng thì email trễ vài phút chứ không hỏng dữ liệu."
    },
    {
      question: "Vì sao Lead, Customer và Deal nên nằm cùng một service?",
      answer: "Vì chúng thay đổi cùng nhau trong cùng một transaction. Tách ra thì một SaveChanges thành một saga ba bước có bù trừ, sinh trạng thái trung gian mâu thuẫn, mà không nhận lại lợi ích nào về scale hay quyền sở hữu."
    },
    {
      question: "Quy tắc kiểm tra ranh giới service là gì?",
      answer: "Nếu hai thực thể thường xuyên thay đổi trong cùng một transaction thì chúng thuộc cùng một service. Tách chúng là biến một cam kết nguyên tử thành một quy trình phân tán."
    },
    {
      question: "Vì sao header tenant không được dùng để phân quyền?",
      answer: "Vì header có thể bị giả mạo nếu ai đó gọi thẳng service mà không qua gateway. Nó chỉ dùng để định tuyến, còn quyền truy cập tenant phải lấy từ claim đã ký trong token."
    },
    {
      question: "Hạn chế của việc nhồi thông tin người dùng vào JWT là gì?",
      answer: "Token chỉ chứa thông tin của người đang gọi API, nhưng màn hình thường cần hiển thị tên của người khác như chủ sở hữu lead hay người tạo ghi chú. Token không giúp gì trong những trường hợp đó."
    },
    {
      question: "Vì sao không nên nhân bản vai trò và quyền?",
      answer: "Vì chúng ảnh hưởng tới bảo mật và không được phép cũ. Một người bị thu hồi quyền mà bản sao vẫn còn quyền cũ là lỗ hổng thật. Chỉ nhân bản những trường dùng để hiển thị."
    }
  ]}
/>
