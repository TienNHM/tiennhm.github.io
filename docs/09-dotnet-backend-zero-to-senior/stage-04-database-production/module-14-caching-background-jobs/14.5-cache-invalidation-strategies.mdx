...
Hàng "quyền" đáng nhấn mạnh: TTL dài nghĩa là thu hồi quyền mất hiệu lực chậm ([bài 10.8](../../stage-03-aspnet-core-backend/module-10-authentication-authorization/10.8-permission-system.mdx)).
...
Nhưng interceptor **không** bắt được `ExecuteUpdateAsync` ([bài 13.8](../module-13-entity-framework-core/13.8-performance.mdx)) — chỗ đó vẫn phải xoá thủ công.
...
**`HybridCache` làm sẵn việc này** khi backend L2 hỗ trợ — đây là lý do mạnh nhất để dùng nó ([bài 14.6](14.6-hybridcache-dotnet-9.mdx)).

Lưu ý: pub/sub **không đảm bảo giao hàng** ([bài 11.11](../../stage-03-aspnet-core-backend/module-11-signalr/11.11-scale-out-and-production.mdx)). Pod mất kết nối Redis trong 5 giây sẽ **bỏ lỡ** thông báo xoá. Vì vậy TTL của L1 phải **ngắn** — 30 giây tới 2 phút — làm lưới an toàn.
