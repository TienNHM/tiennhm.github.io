...
Đây là hành vi mà PostgreSQL có **sẵn** ([bài 12.3](12.3-sql-server-vs-postgresql.mdx)), và nó xoá bỏ phần lớn timeout kiểu "báo cáo chạy 30 giây làm treo mọi người dùng".
...
- **Gửi email, push notification** ([bài 11.8](../../stage-03-aspnet-core-backend/module-11-signalr/11.8-ihubcontext-server-push-outside-hub.mdx)).
...
1. **Thao tác phải idempotent**, hoặc transaction bao trọn để rollback sạch ([bài 9.2](../../stage-03-aspnet-core-backend/module-09-web-api-professional/9.2-rest-api-design-principles.mdx)).
