...
`RCSI` gần như luôn nên bật cho ứng dụng OLTP — nó xoá bỏ phần lớn tranh chấp đọc/ghi. Cái giá là `tempdb` phải chịu tải version store. Chi tiết ở [bài 12.7](12.7-transactions-and-locking.mdx) và trong bài [SQL isolation level](/blog/sql-isolation-level-lost-update-phantom-read).
