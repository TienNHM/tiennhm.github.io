...
**2. Toán tử quét trên bảng lớn.** `Table Scan` hoặc `Clustered Index Scan` với hàng triệu dòng để trả về ít dòng → thiếu index hoặc truy vấn không SARGable ([bài 12.5](12.5-indexing.mdx)).
