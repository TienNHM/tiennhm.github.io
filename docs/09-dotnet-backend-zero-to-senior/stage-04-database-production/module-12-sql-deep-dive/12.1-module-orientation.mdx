...
### 12.1 — Liên kết điều phối (curriculum graph)
...
### 12.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 12.3 — Từ khóa chỉ mục (semantic hooks)
