...
<SummaryBox>
Module này đưa học viên từ in-memory sang database thật. Bạn sẽ thiết kế schema CRM chuẩn hóa, nắm vững SQL nâng cao (CTE, window function, JOIN phức tạp), hiểu cơ chế indexing và execution plan, kiểm soát transaction và lock, và biết khi nào dùng stored procedure thay ORM. Đây là nền tảng bắt buộc trước khi học Entity Framework Core ở Module 13.
</SummaryBox>
