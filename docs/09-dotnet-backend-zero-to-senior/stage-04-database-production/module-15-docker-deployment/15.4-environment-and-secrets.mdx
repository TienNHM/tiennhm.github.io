---
title: "15.4 — 4. Environment và Secrets"
description: "Secret trong biến môi trường lộ qua đâu, build arg nằm lại trong image, xoay khoá, và bốn tầng lưu secret theo môi trường."
sidebar_position: 4
---
...
<Checklist
  title="Danh sách rà soát cấu hình và secret"
  items={[
    { text: "Không có secret nào trong appsettings.json đã commit." },
    { text: "Cùng một image chạy được ở mọi môi trường, chỉ đổi biến." },
    { text: "Không có ARG hay ENV nào chứa secret trong Dockerfile." },
    { text: "Secret lúc build dùng BuildKit secret mount." },
    { text: "Đã kiểm tra docker history và image metadata không chứa secret." },
    { text: "CI có bước quét secret trong mã nguồn và trong image." },
    { text: "Production dùng secret dạng file hoặc Key Vault, không dùng biến môi trường." },
    { text: "Có kế hoạch xoay khoá chấp nhận hai giá trị cùng lúc." },
    { text: "Cấu hình được validate với ValidateOnStart." },
    { text: "Không in giá trị cấu hình ra log, kể cả để kiểm tra." },
    { text: "Đã cân nhắc managed identity để loại bỏ secret cuối cùng." },
  ]}
/>
...
<FAQSection
  items={[
    {
      question: "Vì sao biến môi trường không an toàn cho secret?",
      answer: "Chúng lộ qua docker inspect, qua proc environ từ bên trong container, được tiến trình con kế thừa, và nằm trong crash dump. Thêm nữa nhiều thư viện in cấu hình khi khởi động ở mức Debug, nên bật log Debug trên production là secret vào log."
    },
    {
      question: "Vì sao ARG và ENV trong Dockerfile nguy hiểm?",
      answer: "Chúng nằm trong metadata của image vĩnh viễn và ai cũng đọc được bằng docker history. Xoá ở lệnh RUN sau không giúp gì vì union filesystem chỉ đánh dấu xoá ở layer mới, nội dung vẫn nằm trong layer cũ và trích ra được."
    },
    {
      question: "BuildKit secret mount giải quyết gì?",
      answer: "Secret được mount chỉ trong lúc lệnh đó chạy và không nằm trong bất kỳ layer nào của image. Đó là cách duy nhất đúng để dùng secret lúc build, ví dụ token truy cập NuGet feed riêng."
    },
    {
      question: "Xoay khoá không downtime làm thế nào?",
      answer: "Chấp nhận hai giá trị cùng lúc trong giai đoạn chuyển tiếp. Với JWT thì thêm khoá mới vào danh sách chấp nhận nhưng vẫn ký bằng khoá cũ, rồi chuyển sang ký bằng khoá mới, rồi gỡ khoá cũ sau khi mọi token cũ đã hết hạn."
    },
    {
      question: "Secret dạng file hơn biến môi trường ở đâu?",
      answer: "Nó không lộ qua docker inspect hay proc environ, và không được tiến trình con kế thừa. Docker và Kubernetes đều mount secret thành file; .NET không tự đọc nên bạn cần một configuration provider nhỏ để nạp chúng."
    },
    {
      question: "Managed identity giải quyết vấn đề gì?",
      answer: "Nó loại bỏ secret cuối cùng: ứng dụng xác thực với Key Vault bằng danh tính của chính nó, nên không cần lưu bất kỳ khoá nào ở đâu. Đó là mẫu tốt nhất khi chạy trên cloud."
    }
  ]}
/>
