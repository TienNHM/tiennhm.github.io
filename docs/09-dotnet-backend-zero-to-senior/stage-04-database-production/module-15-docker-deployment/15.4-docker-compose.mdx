...
2. **Cổng mở ra ngoài.** Chạy `docker compose` có `"1433:1433"` trên máy có IP công khai, rồi từ máy khác thử `telnet <ip> 1433`. Đổi sang `127.0.0.1:1433:1433` và kiểm chứng lại.
