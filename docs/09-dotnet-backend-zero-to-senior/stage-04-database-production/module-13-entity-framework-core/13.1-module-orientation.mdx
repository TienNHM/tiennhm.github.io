...
### 13.1 — Liên kết điều phối (curriculum graph)
...
### 13.2 — Tham chiếu có thẩm quyền (E‑E‑A‑T / retrieval)
...
### 13.3 — Từ khóa chỉ mục (semantic hooks)
