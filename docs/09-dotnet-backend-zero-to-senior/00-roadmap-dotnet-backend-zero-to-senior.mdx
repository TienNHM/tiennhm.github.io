...
Cuối **mỗi module** (và các **Project 1–3**, **Final Project**) có mục **Quiz & Lab chấm điểm (100 điểm)** — quiz trắc nghiệm tự đối đáp án + rubric lab (tự chấm / mentor spot-check).
