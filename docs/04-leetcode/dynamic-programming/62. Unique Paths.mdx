...
description: Find the number of possible unique paths that the robot can take to reach the bottom-right corner.
...
<p align="center">
    <img src="./images/robot_maze.png" loading='lazy' decoding='async' alt="2" />
</p>
