...
- **Màu:** Primary `#0080FF` <ColorSwatch hex="#0080FF" />; đa series → màu khác nhau; fill 20% opacity.
- **Hiệu năng:** ⚡ Excellent.  
...
- **Màu:** Box `#BBDEFB` <ColorSwatch hex="#BBDEFB" />, border `#1976D2` <ColorSwatch hex="#1976D2" />, median `#D32F2F` <ColorSwatch hex="#D32F2F" />, outlier `#F44336` <ColorSwatch hex="#F44336" />.
...
- **Màu:** Happy path xanh (`#10B981` <ColorSwatch hex="#10B981" />), deviation cam (`#F59E0B` <ColorSwatch hex="#F59E0B" />), bottleneck đỏ (`#EF4444` <ColorSwatch hex="#EF4444" />).
...
- **Màu:** Actual: solid `#0080FF` <ColorSwatch hex="#0080FF" />; forecast: dashed `#FF9500` <ColorSwatch hex="#FF9500" />; band: shading nhẹ.
...
- **Màu:** Normal xanh; anomaly đỏ (`#FF0000` <ColorSwatch hex="#FF0000" />) với marker rõ + annotation.
...
- **Màu:** Node theo category; edge `#90A4AE` <ColorSwatch hex="#90A4AE" /> opacity ~60%.
...
- **Best chart:** Decomposition tree.  
  **Màu:** Node primary `#2563EB` <ColorSwatch hex="#2563EB" />, node negative `#EF4444` <ColorSwatch hex="#EF4444" />; connector grey.
...
- **Màu:** Current: bright pulse `#00FF00` <ColorSwatch hex="#00FF00" />; history: fade opacity.
...
- **Màu:** Positive xanh (`#22C55E` <ColorSwatch hex="#22C55E" />), negative đỏ (`#EF4444` <ColorSwatch hex="#EF4444" />), neutral xám (`#94A3B8` <ColorSwatch hex="#94A3B8" />).
