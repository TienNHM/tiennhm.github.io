...
- [Character Sets - Collations và vấn đề so sánh chuỗi trong MySQL](/blog/character-sets-and-collations-in-mysql) — Giới thiệu về các bảng mã và cách so sánh chuỗi trong MySQL, những vấn đề cần lưu ý khi làm việc với các bảng mã khác nhau.
